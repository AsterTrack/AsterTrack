...
enum WirelessStatus {
	...
	WIRELESS_STATUS_ENABLED,
	WIRELESS_STATUS_CONNECTED,
	WIRELESS_STATUS_UNABLE,
	WIRELESS_STATUS_ERROR,
	// Flags
	WIRELESS_STATUS_MASK = (32-1),
	WIRELESS_STATUS_FLAGS = ~WIRELESS_STATUS_MASK,
	WIRELESS_STATUS_CONFIGURATED = 32,
	WIRELESS_STATUS_AUTOENABLE = 64
};
...
enum WirelessConfig {
	...
	WIRELESS_CONFIG_RTDATA = 8,
};

enum WirelessAction {
	WIRELESS_ACTION_NONE = 0,
	WIRELESS_STORE_CONFIG,
	WIRELESS_CLEAR_CREDS,
	WIRELESS_DISALLOW_WIFI_PERMANENTLY,
	WIRELESS_DISALLOW_SSH_PERMANENTLY
};
