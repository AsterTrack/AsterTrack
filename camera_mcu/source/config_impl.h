...
#define UARTSEL_CLAIM(PIN) {}
#define UARTSEL_RELEASE(PIN) {}
...
#endif
#define UARTSEL_CLAIM(PIN) GPIO_RESET(UARTSEL_GPIO_X, PIN)
#define UARTSEL_RELEASE(PIN) GPIO_SET(UARTSEL_GPIO_X, PIN)
