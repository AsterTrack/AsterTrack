...
### Flashing & Logging using wlink - WCH-LinkE/WCH-Link (Linux)
...
Build and install <a href="https://github.com/ch32-rs/wlink">ws-link</a> so that `wlink` is in the Path. <br>
...
If you have a WCH-LinkE, you may use the task `Flash SDI-Log CH32V307` to recompile with SDI, flash, and start logging via SDI.
...
Do not this has not been tested yet on Windows, but it should work. <br>
<br>
...
Finally, you need to use <a href="https://zadig.akeo.ie/">Zadig</a> to assign the WinUSB driver to the USB device "WCH-Link" (Presumably on both Interfaces).
